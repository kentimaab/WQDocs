...
Alla tre mallar finns under **Workviews → Templates**. Knapparna och layouten
...
Det finns två sätt att angripa detta — börja från en ny **Workview** eller kopiera en
befintlig mallvy. Det enklaste sättet är att börja med mallvyn,
som innehåller alla nödvändiga skript och konfigurationer. Kopiera **Workview**
**Template_Popup_Small** som finns under **Workviews → Templates** och namnge den nya
