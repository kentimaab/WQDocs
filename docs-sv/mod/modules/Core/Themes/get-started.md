...
Detta gäller även larmstatussfärger. Objekt med aktiva larm visar färger såsom larm- och varningsindikatorer definierade i temat, vilket säkerställer visuell konsekvens mellan teman. Se [Arbetsvy-animationer](../../../guides/workview-animations.md) för hur larmstatusanimationer konfigureras.
