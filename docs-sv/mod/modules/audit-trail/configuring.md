...
Vyn har två paneler. Den vänstra panelen visar alla tillgängliga DataStore-variabler. Den högra panelen visar de variabler som för närvarande spåras.
...
Variabler kan läggas till på valfri nivå i DataStore-trädet. Genom att markera en överordnad nod och klicka på **>** läggs alla variabler under den noden till på en gång.
