...
| Problem | Lösning |
|---|---|
| Signalträdet är tomt | Signalträdet fylls i genom att skanna projektets loggrar. Om inga loggrar är konfigurerade kommer trädet att vara tomt. Kontrollera att minst en logger är aktiv i projektkonfigurationen. |
| En signal saknas i trädet | Endast signaler med en aktiv logger visas i trädet. Använd **Visa variabler som inte loggas** i den projektövergripande vyn för att bekräfta om signalen finns men inte loggas. |
