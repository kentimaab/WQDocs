...
| Två objekt i samma vy har samma lövnamn | Lövets namn utökas med så mycket av taggen som behövs för att skilja dem åt, vilket ger namn som `System1_GT11` och `System2_GT11`. Ett objekt vars namn redan är unikt i sin vy behåller sitt enkla namn. |
