...
| Problem | Lösning |
|---|---|
| Underhållswidgeten på dashboarden visar alltid noll för aktiva uppgifter | Kontrollera att underhållsdatabasens anslutning är aktiv och att underhållstabellen innehåller poster med de förväntade statusvärdena. |
