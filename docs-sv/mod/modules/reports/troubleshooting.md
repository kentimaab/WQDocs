...
| Rapporten skickas inte | Antingen är SMTP-servern inte korrekt konfigurerad — försök skicka ett testmejl från vyn **Rapporter — Schema** för att verifiera. Om det fungerar, kontrollera att e-postadresserna är korrekt angivna. Se [Larm — Utökning](../Core/alarms/extending.md#email-notifications) för SMTP-konfiguration. |
