...
vyn. Dessa egenskaper kan i stället anges på **Workview**-egenskaperna. Om ett
...
**Inställningar → Suffix → Suffix Alias - Workviews**.
...
!!! note
    ...
    [Workview Animations](../guides/workview-animations.md) och [Popups](Popup/index.md) för mer information.
