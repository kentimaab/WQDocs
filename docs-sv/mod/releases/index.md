...
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stöd för flera språk            | Vyer, skript, objektbiblioteket, dynamik och datastore är nu fullt översättningsbara, med en inbyggd språkväljare och flaggikoner för att byta språk i körtid.                                                                                                                                                                            |
...
| Konfigurerbart körtidsbeteende  | Uppdateringsfrekvensen för värdevisning är nu justerbar i körtid, och valt tema (ljust/mörkt) sparas och återställs vid nästa start.                                                                                                                                                                                                      |
...
| Instrumentpanel      | En ny konfigurerbar instrumentpanel byggd från ett bibliotek med återanvändbara widgetobjekt (`Dashboard Widgets.klib`). Widgets fungerar på dator, webb och fjärrklient, startinstrumentpanelen som visas efter inloggning är konfigurerbar, och exempelinstrumentpaneler ingår att bygga vidare på.                                                                                                                              |
...
| Larm                 | En ny larmfrekvensvy visar hur ofta larm inträffar, fjärrlarm kan schemaläggas i larmscheman med sin allvarlighetsgrad och grupp, larmscheman har fått välj-alla / avmarkera-alla-knappar för larmgrupper, knappen "Visa information" stödjer visningsskript, och larmlogghändelser registreras inte längre dubbelt.                                                                                                               |
...
| Område               | Beskrivning                                                                                                                                                                                                                                                                                                                                                                               |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Navigering           | "Loggar" har flyttats in i "Rapporter & loggar", "Underhåll & loggar" har bytt namn till "Underhåll", enskilda menyalternativ kan döljas i körtid, och en knapp för att visa om dolda undernavigeringsalternativ har lagts till.                                                                                                                                                          |
...
| Larmmodul                      | Levande larmlistor med filtrering, larmräknare i navigeringslisten, larmgruppering och allvarlighetsgrad, stöd för autokvittering samt extern avisering via e-post och GSM-modem.  |
