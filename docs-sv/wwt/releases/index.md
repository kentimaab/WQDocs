...
| Dynamiska workview-objekt (DynTouch) | Interaktiva processobjekt som lever upp med live-värden och klickbara popups. |
...
| Larmmodul | Live-larmlistor med filtrering, larmräknare i navigeringsfältet, larmgruppering och allvarlighetsgrad, stöd för automatisk kvittering samt extern avisering via e-post och GSM-modem. |
| Trender och historik | Trендvyer med konsekvent legendnamnsättning och temakänliga färger för läsbara flerkurvediagram. |
