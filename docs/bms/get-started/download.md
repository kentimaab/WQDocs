...
!!! note "Requirements"
    **WideQuick version 14.0.3** or later must be installed before downloading and opening the project files. See [Installing WideQuick](/wq/get-started/Installing-WideQuick) for more information.
