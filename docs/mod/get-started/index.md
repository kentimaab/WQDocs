---
title: Get Started
description: Architecture overview and introduction to WideQuick MOD.
product: mod
...
## A modular architecture { #architecture }
...
## Many industries, one framework { #many-industries }
...
## Keep what you like, discard anything else { #modularity }
...
## Download WideQuick MOD { #download }

WideQuick MOD is available to Kentima partners as a template and demo application. See the download page for requirements and instructions.

[Download WideQuick MOD](download.md){ .md-button .md-button--primary }

## Next steps { #next-steps }

Once you have the project open in **WideQuick Designer®**, the best way to get familiar with the structure is to wire up your first tag end-to-end.

[Your First Tag](Your First Tag.md){ .md-button }
