...
* [**Viewing the Log**](get-started.md#viewing-the-log) — Filtering and reading the trace log.
...
* [**Variables to Track**](configuring.md#configuring-variables-to-track) — Adding and removing variables from the trace log.
