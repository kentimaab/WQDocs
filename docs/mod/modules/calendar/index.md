...
Events come from two sources: custom events created directly in the calendar, and maintenance deadlines pulled automatically from the [Maintenance module](../maintenance/index.md). A configurable reminder is shown a set number of days before each maintenance deadline.
