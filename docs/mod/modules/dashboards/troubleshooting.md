...
| Signal value shows -- or is blank | The signal path passed to the widget does not match any entry in Data Store. Check for typos, confirm the signal exists in Data Store and verify that the driver is connected and writing values. |
