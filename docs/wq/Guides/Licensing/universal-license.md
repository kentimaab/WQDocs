...
<figure markdown="span">
    ![Screenshot of the WideQuick License Config tool's main interface](/docs/Images/Licensing/image-6.png)
...
### 1.	Launch WideQuick License Config
  ...
  ![Icon or shortcut for WideQuick License Config application](/docs/Images/Licensing/image-3.png)
...
=== "On Windows"
    ...
    1.	Press Windows key, search for "Edit Environment Variables," and select "Edit the system environment variables."
        ...
        ![Screenshot showing Windows search for 'Edit Environment Variables'](/docs/Images/Licensing/image.png)
    
    2.	Click "Environment Variables" button.
    
        ![Screenshot of System Properties window with Environment Variables button highlighted](/docs/Images/Licensing/pressENV.png)
    ...
    3.	Under "System variables" (for all users) or "User variables" (for you only), click "New." If you already have an environment variable named WQ_CLOUD_LICENSE press edit instead.
        ...
        ![Screenshot of Environment Variables window showing system variables section](/docs/Images/Licensing/EditEnv.png)

    4.	Enter Variable name: WQ_CLOUD_LICENSE and Variable value: 1.
        
        ![Screenshot of New System Variable dialog with WQ_CLOUD_LICENSE set to 1](/docs/Images/Licensing/image-2.png)
...
=== "On GNU/Linux"
    ...
    1.	Open a terminal and edit your shell profile, you can do this with for example nano via your terminal by entering: 
        ...
        ![Screenshot of terminal window showing nano command](/docs/Images/Licensing/image-4.png)
    ...
    2.	Add this line at the end: 
        ...
        ![Screenshot of nano editor with export WQ_CLOUD_LICENSE=1 line](/docs/Images/Licensing/image-5.png)
...
### 3.	Enter an Application Directory
  ...
  ![Screenshot of WideQuick License Config tool showing directory selection field with browse button](/docs/Images/Licensing/image-9.png)
...
### 4.	Enter Product Key
  ...
  ![Screenshot of product key input field in WideQuick License Config tool](/docs/Images/Licensing/image-7.png)
  ...
  ![Screenshot showing validation icons for product key: red cross for invalid, green checkmark for valid](/docs/Images/Licensing/image-8.png)
...
### 5.	 Input User ID
  ...
  ![Screenshot of User ID input field in WideQuick License Config tool](/docs/Images/Licensing/image-10.png)
...
### 6.	 Select Product Level
  ...
  ![Screenshot of product level dropdown in WideQuick License Config tool](/docs/Images/Licensing/image-11.png)
...
### 7.	Configure External Variables
  ...
  ![Screenshot of External Variables input field in WideQuick License Config tool](/docs/Images/Licensing/image-13.png)
  ...
  ![Screenshot of WideQuick Designer showing variable counter in bottom-right corner](/docs/Images/Licensing/image-12.png)
...
### 8.	Enable Options
  ...
  ![Screenshot of options section in WideQuick License Config tool for additional functionalities](/docs/Images/Licensing/image-14.png)
...
!!! Info
  ...
  ![Screenshot of configuration summary in WideQuick License Config tool before generating license](/docs/Images/Licensing/image-15.png)
...
### 10.  Generate License Key
  ...
  ![Screenshot of Generate key button in WideQuick License Config tool](/docs/Images/Licensing/img.png)
