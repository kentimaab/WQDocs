...
**WideQuick 13.4.1** or later. If not, see [Download WideQuick WWT](download.md)


--8<-- "mod/get-started/Your First Tag.md:body-1"

![Suffix Alarm configuration](/docs/Images/First_tag/SuffixAlarm-wwt.gif)

--8<-- "mod/get-started/Your First Tag.md:body-2"

![Suffix Popup configuration](/docs/Images/First_tag/SuffixPopup-wwt.gif)
